...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Buy and sell used college items: books, electronics, cycles, hostel essentials and notes." },
      { property: "og:title", content: "CampusCart — Student Marketplace" },
      { property: "og:description", content: "Buy and sell used college items on your campus." },
